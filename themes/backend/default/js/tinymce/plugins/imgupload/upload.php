...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $url = get_base_url($config['base_diff']).'/'.str_replace(DIRECTORY_SEPARATOR, '/', $config['upload_path']).'/'.$file_name.'-'.str_pad($i, 4, '0', STR_PAD_LEFT).'.'.$ext;
