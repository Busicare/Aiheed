...
//    return true;c
    ...
    get_menu("admin-menu", "admin-users")->addMenu(lang("verification-questions"), url('admincp/verify/questions'), "admin-verification-qustion");
    get_menu("admin-menu", "admin-users")->addMenu(lang("add-verification-question"), url('admincp/verify/add-question'), "admin-add-verify-qustion");
