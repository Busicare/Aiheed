...
function blog_page_pager($app) {
    ...
    set_meta_tags(array('name' => get_setting("site_title", "AIheed"), 'title' => $blog['title'], 'description' => str_limit(strip_tags($blog['content']), 100), 'image' => $blog['image'] ? url_img($blog['image'], 200) : '', 'keywords' => $blog['tags']));
