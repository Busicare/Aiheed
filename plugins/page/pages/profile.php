...
function page_profile_pager($app) {
    ...
    set_meta_tags(array('name' => get_setting("site_title", "AIheed"), 'title' => get_page_details('page_title'), 'description' => get_page_details('page_desc'), 'image' => get_page_details('page_logo') ? url_img(get_page_details('page_logo'), 200) : '', 'keywords' => ''));
...
function page_photos_profile_pager($app) {
    ...
    return $app->render(view('page::profile/photos', array('photos' => get_photos($app->profilePage['page_id'], 'page-posts'))));
}
