...
register_pager("api/{key}/feed/save", array('use' => "api::feed@save_feed_pager", "filter" => "api"))->where(array("key" => "[a-zA-Z0-9_\-]+"));
...
register_pager("api/{key}/page/invite/friend", array('use' => "api::page@invite_pager", "filter" => "api"))->where(array("key" => "[a-zA-Z0-9_\-]+"));
