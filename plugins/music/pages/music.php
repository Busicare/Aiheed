...
function music_page_pager($app) {
    ...
    set_meta_tags(array('name' => get_setting("site_title", "AIheed"), 'title' => $music['title'], 'description' =>  $music['artist'].' - '.$music['title'], 'image' =>  url_img($music['cover_art'], 920), 'keywords' => ''));
