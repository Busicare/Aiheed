...
function playlist_page_pager($app) {
    ...
    set_meta_tags(array('name' => get_setting("site_title", "AIheed"), 'title' => $play_list['title'], 'description' =>  $play_list['description'], 'image' =>  img('music::images/playlist.png'), 'keywords' => ''));
