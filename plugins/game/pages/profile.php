...
function game_play_profile_pager($app) {
    ...
    set_meta_tags(array('name' => get_setting("site_title", "AIheed"), 'title' => $app->profileGame['game_title'], 'description' => $app->profileGame['game_description'], 'image' => $app->profileGame['game_logo'] ? url_img($app->profileGame['game_logo'], 200) : '', 'keywords' => ''));
    if (is_loggedIn()) {
