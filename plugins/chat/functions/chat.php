...
function get_conversation_message_fields() {
    return "conversation_messages.message_id,conversation_messages.cid,conversation_messages.sender,conversation_messages.message,conversation_messages.files,conversation_messages.image,conversation_messages.time";
}
