...
function event_profile_pager($app) {
    set_meta_tags(array('name' => get_setting("site_title", "AIheed"), 'title' => get_event_details('event_title'), 'description' => get_event_details('event_desc'), 'image' => get_event_details('event_cover') ? url_img(get_event_details('event_cover'), 200) : '', 'keywords' => ''));
