...
function group_profile_pager($app) {
    ...
    set_meta_tags(array('name' => get_setting("site_title", "AIheed"), 'title' => get_group_details('page_title'), 'description' => get_group_details('page_desc'), 'image' => get_group_details('page_logo') ? url_img(get_group_details('page_logo'), 200) : '', 'keywords' => ''));
